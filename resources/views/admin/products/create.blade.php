...
@section('content')
    ...
    @else {{route('admin.product.store')}} @endif" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        <div class="row">
            @csrf
            @if(isset($product))
                @method('PUT')
                ...
                <ul class="list-group row">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="img-thumbnail  text-center">
                            <img src="@if(isset($product)) {{asset('\uploads\product'.$product->thumbnail)}}
                            @else {{asset('images/no-image-icon-13.png')}} @endif" id="imgthumbnail" class="img-fluid" alt="">
                        </div>
                    </li>
                    <li class="list-group-item">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <p type="text" class="form-control" name="featured" placeholder="0.00" aria-label="featured" aria-describedby="featured" >
                                    Featured Product</p>
                            </div>
                        </div>
                    </li>
                    @php
                        ...
                        Arr::pluck($product->categories->toArray(), 'id') : null;
                    @endphp
